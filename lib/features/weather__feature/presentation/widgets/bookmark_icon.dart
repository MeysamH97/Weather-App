            ...
            return BlocConsumer<BookmarkBloc, BookmarkState>(
              ...
              builder: (context, cityState) {
                  ...
                  return Center(
                    child: IconButton(
                        onPressed: () {
                          ...
                          BlocProvider.of<BookmarkBloc>(context).add(SaveCityEvent(name));
                        },
                ...
                return IconButton(
                    onPressed: () {
                      /// call event for save Current City in Database
                      BlocProvider.of<BookmarkBloc>(context).add(DeleteCityEvent(name));
                    },
                    icon:  Icon(Icons.star, color: Colors.white, size: height * 0.04,),);
